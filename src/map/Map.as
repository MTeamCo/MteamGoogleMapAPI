package map {
    ...
    public class Map extends MovieClip {
        ...
        private var _target:MovieClip, _stage:Stage, _path:File, counter:int, _movieMap:MovieClip;

        protected var _fullScreen:Boolean = false;

        public static var dataAddress:String, htmlName:String;
        ...
        public static function setup(dataAddress_p:String = null, htmlName_p:String = null, OnGPS_p:Boolean = false, pauseAutomatically:Boolean = true, accuracy:String ="",onGranted:Function = null,onDenied:Function=null):void {
            ...
            if (OnGPS_p) {
                GPS.setup(DevicePrefrence.isItPC, pauseAutomatically, accuracy,onGranted,onDenied);
            }
        ...
        protected function setFullScreen():void {
            if (_fullScreen && displayMapOption.fullScreenArea != null) {
                ...
                if (DevicePrefrence.isItPC) {
                    displayMapOption.viewPort = new Rectangle(displayMapOption.fullScreenArea.x * StageManager.stageScaleFactor(), displayMapOption.fullScreenArea.y * StageManager.stageScaleFactor(), displayMapOption.fullScreenArea.width * StageManager.stageScaleFactor(), displayMapOption.fullScreenArea.height * StageManager.stageScaleFactor());
                } else {
                    displayMapOption.viewPort = displayMapOption.fullScreenArea;
                }
            } else {
                if (DevicePrefrence.isItPC) {
                    displayMapOption.viewPort = new Rectangle(displayMapOption.area.x * StageManager.stageScaleFactor(), displayMapOption.area.y * StageManager.stageScaleFactor(), displayMapOption.area.width * StageManager.stageScaleFactor(), displayMapOption.area.height * StageManager.stageScaleFactor());
                } else {
                    displayMapOption.viewPort = displayMapOption.area;
                }
            }
